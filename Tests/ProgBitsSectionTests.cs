...
namespace Tests
{
	...
	public class ProgBitsSectionTests
	{
		...
		public void ShouldGetLoadAddress32()
		{
			...
			var sectionsToLoad = elf.GetSections<ProgBitsSection<uint>>().Where(x => x.Header.LoadAddress != 0);
		...
		public void ShouldGetLoadAddress64()
		{
			...
			var sectionsToLoad = elf.GetSections<ProgBitsSection<long>>().Where(x => x.Header.LoadAddress != 0);
